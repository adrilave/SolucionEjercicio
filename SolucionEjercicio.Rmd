...
filas_mammals <- rownames(mammals)
columnas_mammals <- colnames(mammals)
filas_Animals2 <- rownames(Animals2)
columnas_Animals2 <-colnames(Animals2)
...
diferentes_Animales <- setdiff(Animals2,mammals)
diferentes_mammals <- setdiff(mammals,Animals2)
count(setdiff(Animals2,mammals))

rownames(diferentes) %in% rownames(Animals2)
rownames(diferentes) %in% rownames(mammals)
...
```{r}
diffconjuntos <- setdiff(diferentes_Animales, diferentes_mammals)

diffconjuntos2 <- setdiff(diferentes_mammals,diferentes_Animales)
